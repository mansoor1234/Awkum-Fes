  ...
  <div class="card">
    <div class="card-body register-card-body">
      <!-- <p class="login-box-msg">Login Here</p> -->
       <p class="login-box-msg"><b>Students</b> Login</p>
        <center>
      ...
      <form action="" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Registration No" name="email" >
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" name="stdlogin" class="btn btn-primary btn-block">Login</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
