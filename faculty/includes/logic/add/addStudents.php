...
if (isset($addStdnt)) {
	$insert=$conn->prepare("INSERT INTO `students` (`srno`, `campus_id`, `program_id`, `department_id`, `semester_id`, `reg_no`, `name`, `f_name`, `email`, `contact`, `address`, `created_by`, `created_at`) VALUES (NULL, :campus, :program, :department, :semester, :regNo, :name, :fname, :email,:contact, :address,:create, :created)");
