 ...
 <!-- Main Sidebar Container -->
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo BASE_URL;?>assets/img/logo.jpg" alt="QEC LOGO" class="brand-image img-circle elevation-3"
           style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item has-treeview" id="Add" style="display:none ;">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item" id="Campuses" style="display:none ;">
                <a href="<?php echo BASE_URL;?>modules/students/campus.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Campus</p>
                </a>
              </li>
               <li class="nav-item" id="Department" style="display:none ;">
              ...
              <li class="nav-item" id="Semesters" style="display:none ;">
                <a href="<?php echo BASE_URL;?>modules/students/semesters.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Semesters</p>
                </a>
              </li>
              <li class="nav-item" id="Faculty" style="display:none ;">
                <a href="<?php echo BASE_URL;?>modules/students/faculty.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Faculty</p>
                </a>
              </li>
              <li class="nav-item" id="Courses" style="display:none ;">
                <a href="<?php echo BASE_URL;?>modules/students/courses.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Courses</p>
                </a>
              </li>
              <li class="nav-item" id="Students" style="display: ;">
                <a href="<?php echo BASE_URL;?>modules/students/students.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Students</p>
                </a>
              </li>
              <li class="nav-item" id="reports" style="display: ;">
                <a href="<?php echo BASE_URL;?>modules/students/reports.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Reports</p>
                </a>
              </li>
