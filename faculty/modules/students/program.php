              ...
              <table id="example1" class="w-100"  >
                ...
                <tr>
                   ...
                   <td>
                    ...
                    <button name="deleteProgram" class="btn btn-danger btn-xs deleteBtn" type="submit" data-toggle="modal" data-target="#changeImage" value="<?php echo $rows['srno'];?>"  id="deleteBtn" onclick="return confirm('Are you sure?')">Delete
                    </button></div></form></td>
                </tr>
                <?php }?>
               </tbody>
