            ...
            <div class="card-body">
              <table id="example1" class="w-100"  >
                ...
                <tbody id="list">
                    ...
                    $get_users=mysqli_query($con,"SELECT * from course");
                       ...
                       <div class="row">
                        <div class="col-lg-8  col-sm-12 offset-2 mb-2">
                            ...
                            <div class="form-group">
                             <input class="form-control createBtn" type="text" id="courseName" name="courseName" required placeholder="Course Name" onkeypress="return ((event.keyCode>= 97 && event.keyCode <= 122) || (event.keyCode>= 65 && event.keyCode <= 90) || event.keyCode == 8 || event.keyCode == 32);">
                            </div>
                        </div>
                      </div>
                       <div class="row">
                        <div class="col-lg-8  col-sm-12 offset-2 mb-2">
                            <div id="output"></div>
                            <div class="form-group">
                             <input class="form-control createBtn" type="text" id="courseCode" name="courseCode" required placeholder="Course Code" >
                            </div>
                        </div>
                      </div>
                  </div>
