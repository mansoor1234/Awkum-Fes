              ...
              <table id="example1" class="w-100"  >
                ...
                <tr>
                   ...
                   <td>
                    ...
                    <button type="submit" name="deleteDept" class="btn btn-danger btn-xs deleteBtn"   value="<?php echo $rows['dept_id'];?>"  id="deleteBtn" onclick="return confirm('Are you sure?')">Delete
                    </button></div></form></td>
                </tr>
                <?php }?>
               </tbody>
