              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                       ...
                       <div class="row">
                        <div class="col-lg-8  col-sm-12 offset-2 mb-2">
                            ...
                            <div class="form-group">
                             <input class="form-control createBtn" type="text" id="semester" name="semester" required placeholder="Semester Name" onkeypress="return ((event.keyCode>= 97 && event.keyCode <= 122) || (event.keyCode>= 65 && event.keyCode <= 90) || event.keyCode == 8 || event.keyCode == 32);">
                            </div>
                        </div>
                      </div>
                  </div>
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="addSemester" onclick="viladateProduct()"> Save</button>
                  </div>
                   </form>
                </div>
              </div>
             ...
             <div class="modal fade" id="myModal2">
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary" name="addProgram" > Save</button>
                  </div>
                   </form>
                </div>
              </div>
