      ...
      <div class="row">
         <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="btn-group">
               <button type="button" class="btn btn-primary createBtn" data-toggle="modal" data-target="#addFaculty">
                 Add Faculty
               </button>
              </div>
             </div>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" name="addFacilty" onclick="validateFaculty()"> Save</button>
                  </div>
                   </form>
                </div>
              </div>
